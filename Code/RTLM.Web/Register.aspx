...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">
            邮箱</label>
        <div class="controls">
            <input type="text" id="txtboxEmail" placeholder="" />
    ...
    <div class="control-group">
        <label class="control-label" for="inputMobile">
            手机号码</label>
        <div class="controls">
            <input type="text" id="txtboxMobile" placeholder="" />
    ...
    <div class="control-group">
        <label class="control-label" for="inputPassword">
            密码</label>
        <div class="controls">
            <input type="password" id="txtboxPassword" placeholder="" />
    ...
    <div class="control-group">
        <label class="control-label" for="inputPasswordConfirm">
            再次输入密码</label>
        <div class="controls">
            <input type="password" id="txtboxRepeat" placeholder="" />
